...
import { RiAddLine, RiDeleteBinLine, RiFileList3Line } from "@remixicon/react";
    ...
    >
      ...
      >
        ...
        {form.formState.errors.items?.root?.message ? (
          <p className="mt-3 text-paragraph-xs text-error-base" role="alert">
            {form.formState.errors.items.root.message}
          </p>
        ) : null}
        ...
        */}
                ...
                {fields.map((field, index) => {
                  ...
                  return (
                    <tr key={field.id} className="align-top">
                      <td className="px-3 pt-5 text-center font-mono text-paragraph-xs text-text-soft-400">
                        {index + 1}
                      </td>
                      <td className="px-3 py-3">
                        ...
                        {descError ? (
                          <p
                            className="mt-1 text-paragraph-xs text-error-base"
                            role="alert"
                          >
                            {descError}
                          </p>
                      ...
                      <td className="px-3 pt-5 text-right font-semibold tabular-nums text-text-strong-950 text-paragraph-sm">
                        {itemCalc.isValid
          ...
          <div className="mt-4 space-y-4">
            {fields.map((field, index) => {
              ...
              return (
                <div
                  key={field.id}
                  className="rounded-xl bg-bg-weak-50 p-4 ring-1 ring-inset ring-stroke-soft-200"
                >
                  ...
                  <div className="mt-3 space-y-3">
                    ...
                    <div className="flex items-center justify-between border-t border-stroke-soft-200 pt-2 text-paragraph-xs">
        ...
        <div className="mt-6 flex flex-col gap-3 rounded-xl bg-bg-weak-50 p-4 ring-1 ring-inset ring-stroke-soft-200 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-baseline justify-between gap-4 sm:justify-end">
            ...
            <strong className="text-title-h5 font-semibold tracking-tight tabular-nums text-text-strong-950">
