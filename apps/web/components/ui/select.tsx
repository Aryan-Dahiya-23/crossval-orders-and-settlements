...
export function Select({
  ...
  return (
    <div className="relative inline-block w-full">
      <select
        className={cnExt(
          "h-9 w-full rounded-lg bg-bg-white-0 px-3 py-1.5 pr-8 text-paragraph-sm text-text-strong-950 shadow-regular-xs ring-1 ring-inset ring-stroke-soft-200 outline-none transition duration-200 ease-out hover:bg-bg-weak-50 focus:shadow-button-important-focus focus:ring-stroke-strong-950 disabled:bg-bg-weak-50 disabled:text-text-disabled-300 appearance-none",
          className,
        )}
        {...props}
      >
      ...
      <RiArrowDownSLine className="pointer-events-none absolute right-2.5 top-1/2 size-4 -translate-y-1/2 text-text-sub-600" />
    </div>
  );
}
